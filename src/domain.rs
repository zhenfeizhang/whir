...
{
    generator: F,
    base_domain_size: usize,
    // backing_domain_size: usize,
    ...
    F: FFTField,
{
    ...
    pub fn folded_size(&self, folding_factor: usize) -> usize {
        assert!(self.base_domain_size % (1 << folding_factor) == 0);
        self.base_domain_size >> folding_factor
    }

    /// Returns the total size of the domain.
    pub fn size(&self) -> usize {
        self.base_domain_size
    }
    ...
    pub fn scale(&self, power: usize) -> Self {
        Self {
            generator: self.generator.exp((power as u64).into()),
            base_domain_size: self.base_domain_size / power,
        }
