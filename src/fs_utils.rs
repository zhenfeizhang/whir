...
//     type Field64 = Goldilocks;

//     #[test]
//     fn test_add_ood() {
//         // let domainsep: DomainSeparator = DomainSeparator::new("test_protocol");
//         let domainsep = BytesHashTranscript::<Keccak256hasher>::new();

//         // Apply OOD query addition
//         let updated_domainsep =
//             <BytesHashTranscript as OODDomainSeparator<Field64>>::add_ood(domainsep.clone(), 3);
...
//             <BytesHashTranscript as OODDomainSeparator<Field64>>::add_ood(domainsep, 0);
