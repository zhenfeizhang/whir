...
//         let coset_offset = root_of_unity.pow(index as u128);
//         // Compute coset generator = ω^{N / 2^m}
//         let coset_gen = root_of_unity.pow((domain_size / folding_factor_exp) as u128);
...
//                     coset_offset * coset_gen.pow(i as u128),
//                     num_variables,
//                 ))
//             })
//             .collect();
